	...
	<form id='reservation-form' action="/reservationAction" method="POST" onsubmit='return purChaserInfo.checkBeforeSubmit()'>
		...
		<article class="terms">
			...
			<div class="personal-info-terms">
				...
				<div class="specific-personal-info-terms">개인정보보호법에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
...
이용자는 개인정보의 수집 및 이용 동의를 거부할 권리가 있습니다. 회원가입 시 수집하는 최소한의 개인정보, 즉, 필수 항목에 대한 수집 및 이용 동의를 거부하실 경우, 회원가입이 어려울 수 있습니다.</div>
			...
			<div class="personal-info-terms">
				┖개인정보 제3자 제공 동의<span class="terms-span">보기<img
					alt="위가 열린 꺾쇠" src="/getImage/img/openTopClamp.png"></span>
				<div class="specific-personal-info-terms">여러분을 환영합니다.
...
공지 일자: 2018년 3월 30일
적용 일자: 2018년 5월 1일
네이버 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.</div>
			</div>
		</article>
